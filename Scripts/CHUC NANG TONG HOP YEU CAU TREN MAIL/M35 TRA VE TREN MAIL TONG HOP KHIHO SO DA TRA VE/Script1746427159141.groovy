...
IPaper.documentInformationScreen.performAction(document, DocumentActionType.RETURN)
...
IPaper.outlook_mailScreen.actionSummarizeEmail(document, ActionType.RETURN, 'Cuong check mail nha')
