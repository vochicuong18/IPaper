...
String COMMENT = 'Duyệt có cc nhập ý kiến'
...
def cc = DataTest.getUserA3NVTest()
...
IPaper.inComingDocument.viewMainFile(documentTitle)

//Assinger approve document

IPaper.documentInformationScreen.approveAddCC(cc, COMMENT)
...
IPaper.documentInformationScreen.checkAssigner(assigner.getEmail())
