...
IPaper.documentInformationScreen.checkAssigner(auto6)

IPaper.documentInformationScreen.checkAssigner(auto7)

IPaper.documentInformationScreen.checkAssigner(auto8)
